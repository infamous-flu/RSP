# source https://github.com/nissymori/JAX-CORL/blob/main/algos/iql.py
...
def save_critic(
    train_state: IQLTrainState, save_path: str
):
...
if __name__ == "__main__":
    ...
    save_critic(train_state, f"critics/{config.env_name}_critic.pkl")
    # final evaluation
    policy_fn = partial(
        act_fn,
        temperature=0.0,
